...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-3&gv1ax#p_fun%@12^&l0tj7p*#1&oa^b-$m*it@aw7^3(mp0t')
...
from datetime import timedelta
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=250),  # Durée de vie du token
